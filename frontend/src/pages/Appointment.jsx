    ...
    <div className="container mx-auto p-4 bg-[#F8F2DE]">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6 flex flex-col md:flex-row gap-6">
        ...
        <div className="md:w-2/3">
          ...
          <h1 className="text-2xl font-bold text-[#A31D1D] mb-2">{docInfo.name}</h1>
          <div className="flex flex-wrap gap-2 mb-4">
            <p className="bg-[#ECDCBF] text-[#A31D1D] px-3 py-1 rounded-full text-sm">{docInfo.degree}</p>
            <p className="bg-[#ECDCBF] text-[#A31D1D] px-3 py-1 rounded-full text-sm">{docInfo.speciality}</p>
            <button className="bg-[#D84040] text-white px-3 py-1 rounded-full text-sm">{docInfo.experience}</button>
          </div>
          ...
          <p className="text-lg font-medium">
            Appointment Fee: <span className="text-[#D84040] font-bold">${docInfo.fee}</span>
          </p>
        </div>
      </div>
      ...
      <div className="mb-6">
        <h2 className="text-xl font-bold text-[#A31D1D] mb-4">Similar {docInfo.speciality} Doctors</h2>
